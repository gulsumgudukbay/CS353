...
$sql1 = "SELECT * FROM user_message WHERE from_id = 'myuser_id'";
$result1 = mysqli_query($db,$sql1);

<div id="inbox">
	<h2>Your messages<a href = "./new_message.php">New Message</a></h2>
	while($row = mysqli_fetch_array($result1))
	{
		<div id="message" style="background-color:#FFC73C;width:500px">
    	<h3>echo From: $row["user_name"]</h3>
    	<p2>echo $row["text"]</p2>
    	<hr/><hr/>
  		</div>
	}
